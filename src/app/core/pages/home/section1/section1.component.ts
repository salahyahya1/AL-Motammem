...
import { ApplicationRef, Component, inject, Inject, NgZone, OnDestroy, PLATFORM_ID, ViewChild, ViewEncapsulation } from '@angular/core';
...
@Component({
  ...
  imports: [AnimatedSequenceComponent, RouterLink,TranslatePipe,TranslateDirective],
})
