    ...
    document.fonts.ready.then(() => {
      ...
      mm.add({
        ...
        ScrollTrigger.create({
          ...
          animation: tl,
          onEnter: () => {
            gsap.to(section, { backgroundColor: "transparent", duration: 0.1, ease: "sine.out" });
            gsap.to(video, { opacity: "1", duration: 0.1, ease: "sine.out" });
            video?.play();
            gsap.to(image, { opacity: "1", duration: 0.1, ease: "sine.out" });
          },
